...
public class players extends JFrame {
	...
	public JRadioButton rdbtn2 ,rdbtn3;
	...
	public players(SnakeAndLadder mf) {
		setTitle("Snakesssss and Ladders");
		setResizable(false);
		...
		btnDone.addActionListener(new ActionListener() {
			...
			if(rdbtn2.isSelected() && (name1.isEmpty() || name2.isEmpty()))
				...
				if(rdbtn3.isSelected())
					{
					JOptionPane.showMessageDialog(null, name3 +" your colour is WHITE!!");
		...
		Group.add(rdbtn3);
		rdbtn3.setBounds(277, 46, 109, 23);
		panel.add(rdbtn3);
