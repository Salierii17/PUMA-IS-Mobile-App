...
public class Instructions extends JFrame {
	...
	public Instructions() {
		...
		JLabel lblTryToClimb = new JLabel("Try to climb the ladders and stay safe" ,JLabel.CENTER);
		...
		JLabel lblFromTheSnakesfirst = new JLabel("from the snakes.First one to reach" ,JLabel.CENTER);
